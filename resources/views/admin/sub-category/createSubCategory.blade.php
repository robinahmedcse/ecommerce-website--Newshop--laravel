...
<div class='row '>
    <div class="">
        <h2 class="tex text-center text-success">Add Sub Category</h2>
    </div> 
    <div class="">
...
<!--        <form action="" method="POST"id="demo-form2" data-parsley-validate class="form-horizontal form-label-left">-->
             {!! Form::open(['url'=>'admin/save-sub-category','method'=>'POST','class'=>'form-horizontal form-label-left']) !!}
            <!-- Category name -->
            ...
            <div class="form-group">
                ...
                <div class="col-md-6 col-sm-6 col-xs-12">
                    <input type="text" id="" name="sub_category_name" class="form-control col-md-7 col-xs-12">
            ...
            <div class="form-group">
                ...
                <div class="col-md-6 col-sm-6 col-xs-12">
                    <textarea class='form-control' name='sub_category_description' row='8 '></textarea>
