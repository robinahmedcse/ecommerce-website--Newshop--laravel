...
//echo"<pre>";
//print_r($publishedCategories);
//print_r($publishedSubCategories);
//?>
                                    ...
                                    <ul class="nav navbar-nav">
                                        ...
                                        <!-- Mega Menu -->
                                          ...
                                          @foreach($publishedCategories as $Category)
                                           <?php 
                                               $encrypted_category_id= Crypt::encryptString($Category->category_id);
                                              ?>
                                          <li><a href="{{url('category-details/'.$encrypted_category_id)}}">{{$Category->category_name}}</a></li>
                                           @endforeach
