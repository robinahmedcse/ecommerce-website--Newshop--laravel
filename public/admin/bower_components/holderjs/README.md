...
![](http://imsky.github.io/holder/{{asset('public/frontEnd/')}}/images/header.png)
...
Holder will then process all {{asset('public/frontEnd/')}}/images with a specific ``src`` attribute, like this one:
...
![](http://imsky.github.io/holder/{{asset('public/frontEnd/')}}/images/holder_sky.png)![](http://imsky.github.io/holder/{{asset('public/frontEnd/')}}/images/holder_vine.png)![](http://imsky.github.io/holder/{{asset('public/frontEnd/')}}/images/holder_lava.png)
...
Using custom themes and domain on specific {{asset('public/frontEnd/')}}/images
-------------------------------------------------

You can use Holder in different areas on different {{asset('public/frontEnd/')}}/images with custom themes:
...
Holder.run({
  ...
  {{asset('public/frontEnd/')}}/images: "#new"
});
```
...
Holder can render placeholders as background {{asset('public/frontEnd/')}}/images for elements with the `holderjs` class, like this:
...
Holder is compatible with ``lazyload.js`` and works with both fluid and fixed-width {{asset('public/frontEnd/')}}/images. For best results, run `.lazyload({skip_invisible:false})`.
...
angular.module('MyModule').directive('myHolder', function() {
  return {
    link: function(scope, element, attrs) {
      ...
      Holder.run({{{asset('public/frontEnd/')}}/images:element[0]});
    }
  };
});
```
