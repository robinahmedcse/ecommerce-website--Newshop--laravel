...
(function(register, global, undefined) {
	...
	var Holder = {
		...
		/**
		 * Runs Holder with options. By default runs Holder on all {{asset('public/frontEnd/')}}/images with "holder.js" in their source attributes.
		 *
		 * @param {Object} userOptions Options object, can contain domain, themes, {{asset('public/frontEnd/')}}/images, and bgnodes properties
		 */
		run: function(userOptions) {
			...
			var {{asset('public/frontEnd/')}}/images = getNodeArray(options.{{asset('public/frontEnd/')}}/images);
			...
			for (i = 0; i < {{asset('public/frontEnd/')}}/images.length; i++) {
				var image = {{asset('public/frontEnd/')}}/images[i];
				var imageAttr = {};
	...
	var App = {
		settings: {
			domain: 'holder.js',
			{{asset('public/frontEnd/')}}/images: 'img',
			objects: 'object',
		...
		if (mode == 'image') {
			...
			if (renderSettings.renderer == 'html') {
				...
				if (flags.textmode && flags.textmode == 'exact') {
					App.vars.resizable{{asset('public/frontEnd/')}}/images.push(el);
	...
	function updateResizableElements(element) {
		var {{asset('public/frontEnd/')}}/images;
		if (element == null || element.nodeType == null) {
			{{asset('public/frontEnd/')}}/images = App.vars.resizable{{asset('public/frontEnd/')}}/images;
		} else {
			{{asset('public/frontEnd/')}}/images = [element];
		}
		for (var i in {{asset('public/frontEnd/')}}/images) {
			if (!{{asset('public/frontEnd/')}}/images.hasOwnProperty(i)) {
				continue;
			}
			var el = {{asset('public/frontEnd/')}}/images[i];
			if (el.holderData) {
	...
	App.vars = {
		preempted: false,
		resizable{{asset('public/frontEnd/')}}/images: [],
		debounceTimer: null,
		cache: {}
	};
